...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'timelinejs_timeline', 'start_date', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'TimelineEvent.end_date'
        db.alter_column(u'timelinejs_timelineevent', 'end_date', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'TimelineEvent.start_date'
        db.alter_column(u'timelinejs_timelineevent', 'start_date', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Timeline.start_date'
        db.alter_column(u'timelinejs_timeline', 'start_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'TimelineEvent.end_date'
        db.alter_column(u'timelinejs_timelineevent', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'TimelineEvent.start_date'
        db.alter_column(u'timelinejs_timelineevent', 'start_date', self.gf('django.db.models.fields.DateField')())
