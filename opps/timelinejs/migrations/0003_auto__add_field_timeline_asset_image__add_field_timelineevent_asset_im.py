...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Timeline.asset_image'
        db.add_column(u'timelinejs_timeline', 'asset_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='timeline_image', null=True, on_delete=models.SET_NULL, to=orm['images.Image']),
                      keep_default=False)

        # Adding field 'TimelineEvent.asset_image'
        db.add_column(u'timelinejs_timelineevent', 'asset_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='timelineevent_image', null=True, on_delete=models.SET_NULL, to=orm['images.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Timeline.asset_image'
        db.delete_column(u'timelinejs_timeline', 'asset_image_id')

        # Deleting field 'TimelineEvent.asset_image'
        db.delete_column(u'timelinejs_timelineevent', 'asset_image_id')
    ...
    models = {
        ...
        u'timelinejs.timeline': {
            ...
            'asset_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'timeline_image'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['images.Image']"}),
        ...
        u'timelinejs.timelineevent': {
            ...
            'asset_caption': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'asset_credit': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'asset_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'timelineevent_image'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['images.Image']"}),
            'asset_media': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
